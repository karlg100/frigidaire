...
Frigidaire.prototype.resetAll = function(credentials, callback) {
  this.loginData = null;
  this.deviceList = null;
...
Frigidaire.prototype.getTelem = function(credentials, callback) {
  var self = this;
  ...
  self.get('/apps/services/api/ELXSmart/iphone/query', form, function(err, data) {
    ...
    //self.loginData = self.stripJSON(data);
    self.telemetry = self.stripJSON(data).resultSet;
...
Frigidaire.prototype.setTemp = function(applianceId, temp, callback) {
  ...
  this.sendAction(applianceId, this.TEMP, temp, callback);
};
